...
CREATE TABLE `ingredientes` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `ingredientes_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `ingredientes_ibfk_2` FOREIGN KEY (`empleado_id`) REFERENCES `empleados` (`id`)
